...
function fireConfetti(){
  ...
  // wide burst from the bottom-center, scattering upward in many directions
  spawnBurst(W / 2, H * 0.85, 55, 125, 10, 20, 90);
  // side cannon: bottom-left shooting diagonally up-right
  spawnBurst(W * 0.04, H * 0.95, 25, 70, 14, 24, 55);
  // side cannon: bottom-right shooting diagonally up-left
  spawnBurst(W * 0.96, H * 0.95, 110, 155, 14, 24, 55);
